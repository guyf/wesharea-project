...
DATABASES = {
    'default': {
        ...
        'NAME': 'bbm', # Or path to database file if using sqlite3.
        'USER': 'bbm',                      # Not used with sqlite3.
        'PASSWORD': '66m',                  # Not used with sqlite3.
...
EMAIL_HOST_USER  = ''
EMAIL_HOST_PASSWORD = ''
DEFAULT_FROM_EMAIL = 'noreply@wesharea.com'
